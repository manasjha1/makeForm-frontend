        ...
        <header className="w-full p-2 bg-white backdrop:blur-lg shadow-lg/20">
            <nav className="w-full md:w-[90%] h-full flex items-center justify-between m-auto gap-3">
                <div className="flex items-center justify-evenly gap-6">
                    ...
                    <div className="bg-[#FAF9F6] flex items-center gap-2 rounded-sm border border-gray-300 py-1 px-2">
                        <div className="hidden md:flex items-center bg-[#FAF9F6] p-1 rounded-sm border border-[#E2E8E4]">
                            <Button onClick={() => setViewPage("Home")} className="text-[12px] font-normal rounded-sm">
                                <Home className="size-3" /> Home
                            </Button>
                            <Button onClick={() => setViewPage("FormBuilder")} className="text-[12px] font-normal rounded-sm">
                                <LayoutFreeform className="size-3" /> Form Builder
                            </Button>
                            <Button onClick={() => setViewPage("LivePreview")} className="text-[12px] font-normal rounded-sm">
