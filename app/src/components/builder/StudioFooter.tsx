...
export default function StudioFooter({ onTemplates, onPreview }: { onTemplates: () => void; onPreview: () => void }) {
    return <footer className="studio-footer">
        <div className="studio-footer-grid">
            ...
            <div><h3>PRODUCT</h3><Link to="/">Landing Page</Link><button className="studio-footer-link" onClick={onTemplates}>Form Templates</button><button className="studio-footer-link" onClick={onPreview}>Live Preview</button></div>
