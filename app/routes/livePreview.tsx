    ...
    return <div className="min-h-screen bg-[#faf8f5]">
        ...
        <main className="mx-auto max-w-2xl space-y-6 px-4 py-10">
            ...
            {!ready ? <p role="status">Loading draft…</p> : form ? <>
                <div className="flex flex-wrap items-center justify-between gap-3"><Button asChild variant="outline"><Link to={`/form-builder?template=${encodeURIComponent(form.id)}`}>Back to editor</Link></Button><p className="text-xs text-gray-500">Draft saved for this browser tab</p></div>
