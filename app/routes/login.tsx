        ...
        <section className="p-2 m-2">
          <Card className="w-full mx-auto sm:max-w-md shadow-xl ">
            ...
            <CardFooter>
              ...
              >
                <Button
                  className="rounded-sm border border-emerald-700 text-emerald-700 hover:bg-gray-500/5 hover:text-emerald-700"
                  type="button"
                  variant="outline"
                  onClick={() => form.reset()}
                >
                ...
                <Button
                  className="rounded-sm bg-emerald-700 text-white hover:bg-emerald-800"
                  type="submit"
                  form="login-form"
                >
                  Submit
